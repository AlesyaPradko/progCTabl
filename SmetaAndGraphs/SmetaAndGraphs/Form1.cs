   ...
   bool Flag { get; set; }
    ...
    public partial class Form1 : Form, IForm1
    {
       ...
       public  bool Flag { get { return _flag; } set { _flag = value; } }
        ...
        private void butStartChoise_Click(object sender, EventArgs e)
        {
            if (_smetaAdres != null && _aktKSAdres != null && _saveAdres != null)
            {
                groupBoxSmeta.Visible = true;
                butStartWorkSmet.Visible = true;
            }
            else
            {
                MessageBox.Show("Вы пытаетесь выполнить работу, но не выбрали папку со сметами, актами КС и для сохранения!", "Предупреждение", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
        }     
