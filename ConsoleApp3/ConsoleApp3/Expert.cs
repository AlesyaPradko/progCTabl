    ...
    public class Expert:Worker
    {
        ...
        protected override void ProcessSmeta(int num, string sx1, string sx2)
        {
            ...
            try
            {
                ...
                Sheetc = CopySmet[num].Sheets[1];
                Excel.Range rangec;
                rangec = Sheetc.get_Range(sx1, sx2);
                Excel.Range firkeys = rangec.Find("Номер");
                Excel.Range firvalsm = rangec.Find("Количество");
                ...
                ParserExc.FormatZapis(num, AdresSmeta, numKS, AdresKS, firkeys, firvalsm, Sheetc, rangec);
                ...
                //    }
                //}
                Zakrutie(AdresSmeta, KskSmete, ContainPapkaKS, AdresKS, CopySmet, num, Sheetc, rangec);
            }
